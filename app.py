...
#     with open('/home/kuoluo/projects/FundAnalysis/data/explore/return_distribution_value.json', 'r',
...
#     with open('/home/kuoluo/projects/FundAnalysis/data/explore/company_date_fund_value.json', 'r',
#               encoding='UTF-8') as fp:
...
#     c_name = request.get_json()['c_names'][0]
#     with open('/home/kuoluo/projects/FundAnalysis/data/explore/company_date_manager_value.json', 'r',
#               encoding='UTF-8') as fp:
...
#     c_name = request.get_json()['c_names'][0]
#     with open('/home/kuoluo/projects/FundAnalysis/data/explore/company_date_asset_value.json', 'r',
#               encoding='UTF-8') as fp:
